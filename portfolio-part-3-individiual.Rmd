...
set.seed(133742)
options(digits=3)
knitr::opts_chunk(fig.width = 10, warning = FALSE)
...
[Titanic passenger class accommodation location](https://www.encyclopedia-titanica.org/files/1/figure-one-side-view.gif)